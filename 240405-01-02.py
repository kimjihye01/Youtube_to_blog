...
st.sidebar.write("1.유튜브 링크를 가져오세요. ('v='이 있는 링크로 가져오세요.)")
st.sidebar.write("2.유튜브 링크를 넣고 확인을 누르세요.")
st.sidebar.write("3.잠시만 기다리세요.")
st.sidebar.write("4.결과물 완성!")
st.sidebar.write(" ")
st.sidebar.header("링크")
st.sidebar.page_link("https://seowan.net/", label="제작자 홈페이지",icon="🏠")
        ...
        if error == 0:
            for i in range(5):
                try:
                    ...
                    template_text = """
                            아래 입력문에서 영어 키워드 5개만 뽑아내세요. 뽑아낸 키워드는 쉼표로 구분해주세요. 예시랑 똑같이 작성하지 마세요.
